                        ...
                        <div class="max-w-sm w-full lg:max-w-full lg:flex shadow py-2">
                            <div class="flex-col pl-2">
                                <a href="<?php the_permalink(); ?>">
                                    ...
                                    <!--                                    <img src="-->
                                    <?php //the_post_thumbnail_url();?><!--" alt="--><?php //the_title(); ?><!--">-->
                                    <!--                                </div>-->
                                </a>
                            ...
                            <div class="bg-white rounded-b lg:rounded-b-none lg:rounded-r p-2 flex flex-col justify-between leading-normal">
                                <div class="mb-4">
                                    <div class="text-gray-900 font-bold text-xl mb-2"><a href="<?php the_permalink(); ?>"><p
                                                    class="text-xl"><?php the_title(); ?></p></a></div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <?php //echo get_avatar('user_email');?><!--" alt="Avatar of Jonathan Reinink">-->
