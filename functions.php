...
// Hooks
add_action('wp_enqueue_scripts', 'JvwTheme_enqueue');
add_action( 'after_setup_theme', 'JvwTheme_setup_theme' );
add_action( 'widgets_init', 'JvwTheme_widgets' );
